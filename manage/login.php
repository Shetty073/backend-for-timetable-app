...
<head>
    ...
    <title>TimeTable App - Backend Management System</title>
    <meta name="author" content="Ashish Shetty">
    <link rel="stylesheet" href="bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="css/login.css">
</head>
<body>
<h1 class="display-1 login-brand" style="text-align:center;">TimeTable App Manager</h1>
...
<div class="container login-form">
    <form name="login-form" method="POST" action="login/login_process.php">
        ...
        <div class="form-group">
            ...
            <small id="emailHelp" class="form-text text-muted">Do not write down your password anywhere.</small>
