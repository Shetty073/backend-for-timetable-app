...
<head>
    ...
    <title>Admin Console - Update SY B.Com - C Timetable</title>
    ...
    <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link" href="./../sy_commerce_A.php">value
                            Second Year - B.Com - A
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./../sy_commerce_B.php">
                            Second Year - B.Com - B
                        </a>
                    </li>
                    <hr>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h4 class="h4">Second Year - B.Com - C Division</h4>
            </div>
            ...
            <form name="f1" method="post" action="../../../update_process/update_process.php">
                <table class="table table-hover table-danger">
                    ...
                    $query = "SELECT * FROM sy_commerce_c";
                ...
                <input type="hidden" name="class_name" value="sy_commerce_c">
                <br>
                <div class="container text-center">
                    <button type="submit" class="btn btn-outline-secondary btn-sav-can">Save changes</button>
                    <a class="btn btn-secondary btn-sav-can" href="./../sy_commerce_C.php">Cancel</a>
                </div>
            </form>
        </main>
    </div>
