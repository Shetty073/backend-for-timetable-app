...
<head>
    ...
    <title>Admin Console - SY Commerce</title>
    ...
    <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link" href="./fy_commerce.php">
                            First Year - BMS
                        </a>
                    </li>
                    <li class="nav-item">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h4 class="h4">Second Year - Commerce</h4>
            </div>

            <a href="./sy/sy_commerce_A.php" class="card-link">
                <div class="card" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title">Second Year - Commerce - A </h5>
                        <h6 class="card-subtitle mb-2 text-muted">Division</h6>
                    </div>
                </div>
            </a>
            <a href="./sy/sy_commerce_B.php" class="card-link">
                <div class="card" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title">Second Year - Commerce - B </h5>
                        <h6 class="card-subtitle mb-2 text-muted">Division</h6>
                    </div>
                </div>
            </a>
            <a href="./sy/sy_commerce_C.php" class="card-link">
                <div class="card" style="width: 18rem;">
                    <div class="card-body">
                        <h5 class="card-title">Second Year - Commerce - C </h5>
                        <h6 class="card-subtitle mb-2 text-muted">Division</h6>
                    </div>
                </div>
            </a>
