...
<head>
    ...
    <title>Admin Console - Update FY BMS Timetable</title>
    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <form name="f1" method="post" action="../../update_process/update_process.php">
                ...
                <input type="hidden" name="class_name" value="fy_bms">
                <br>
                <div class="container text-center">
                    <button type="submit" class="btn btn-outline-secondary btn-sav-can">Save changes</button>
                    <a class="btn btn-secondary btn-sav-can" href="./../fy_bms.php">Cancel</a>
                </div>
            </form>
        </main>
    </div>
