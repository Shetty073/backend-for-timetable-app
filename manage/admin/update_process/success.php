...
?>
    ...
    <head>
        ...
        <title>TimeTable App Backend - Successfully Updated</title>
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4 container">
        ...
        <div class="container text-center">
            <div class="container card error-header text-center">
                <h1 class="h1 text-danger card-header text-center">Success</h1>
                <div class="container error-body card-body">
                    <p class="text-center">
                        <?php

                        if (isset($_GET["class"])) {
                            echo "Database successfully updated for " . $_GET['class'] . "<br>";
                        }
                        ?>
                    </p>
                </div>
