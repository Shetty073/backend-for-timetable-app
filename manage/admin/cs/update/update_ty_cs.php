...
<head>
    ...
    <title>Admin Console - Update TY B.Sc CS Timetable</title>
    ...
    <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./../sy_cs.php">
                            Second Year - B.Sc CS
                        </a>
                    </li>
                    <hr>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h4 class="h4">Third Year - B.Sc CS</h4>
            </div>
            ...
            <form name="f1" method="post" action="../../update_process/update_process.php">
                ...
                <input type="hidden" name="class_name" value="ty_cs">
                <br>
                <div class="container text-center">
                    <button type="submit" class="btn btn-outline-secondary btn-sav-can">Save changes</button>
                    <a class="btn btn-secondary btn-sav-can" href="./../ty_cs.php">Cancel</a>
                </div>
            </form>
        </main>
    </div>
